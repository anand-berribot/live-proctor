...
export function useNavData1() {
  ...
  //           // {
  //           //   title: t('Report'),
  //           //   path: paths.adminDashboard.adminReport,
  //           //   icon: ICONS.file,
  //           // },
  //         ],
  //       }
  ...
  //             path: paths.userDashboard.addJd,
  //             icon: ICONS.blank,
  //           },
  //           {
  //             title: t('Schedule Interview'),
  //             path: paths.userDashboard.scheduling,
  //             icon: ICONS.calendar,
  //           },
  //           {
  //             title: t('History'),
  //             path: paths.userDashboard.history,
  //             icon: ICONS.folder,
  //           },
  //           {
  //             title: t('Report'),
  //             path: paths.userDashboard.report,
  //             icon: ICONS.file,
  //           },
  //         ],
  //       }
  ...
  const data1 = useMemo(() => {
    // if (!user) {
    //   // No user or invalid user state
    //   console.error('No valid user found in localStorage.');
    //   return [];
    // }

    // Admin Navigation
    if (user.is_admin && !user.is_owner && !user.is_user) {
      return [
        {
          // Admin Menu
          // subheader: t('overview'),
    ...
    if (user.is_owner && !user.is_admin && !user.is_user) {
      return [
        {
          // Super Admin Menu
          items: [
            ...
            // {
            //   title: t('Report'),
            //   path: paths.superAdminDashboard.superAdminReport,
            //   icon: ICONS.file,
            // },
          ],
        },
    ...
    if (user.is_user && !user.is_admin && !user.is_owner) {
      return [
        {
          // Regular User Menu
          // subheader: t('overview'),
    ...
    console.error('Unhandled user role or invalid state.');
    return [];
  }, [t]);
