...
const usePermissions = () => {
    const { cameraAllowed, requestCameraAccess, checkCameraPermission, cameraError } = useCamera();
    const { micAllowed, requestMicAccess, checkMicPermission, micError } = useMicrophone();
